...
Generated 2026-09-16T02:35:36Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
| 2 | 2 | 6 + 强 → 214214 + 强 | 6+HP → 22+PPP | 5900 | 5900 | OD 1, drive >=0 (1 unknown) | 8.9 | medium | 0/1 pairs reproduced |
| 3 | 3 | 6 + 弱 + 中 + 强 → 6 + 强 → 214214 + 强 | 6+KKK → 6+HP → 22+PPP | 5900 | 6900 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 4 | 4 | 2 + 弱 + 中 + 强 → 2 + 强 → 214214 + 强 | 2+KKK → 2+HP → 22+PPP | 5900 | 6900 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 5 | 5 | 2 + 强 → 214214 + 强 | 2+HP → 22+PPP | 5800 | 5800 | OD 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs reproduced |
| 6 | 6 | 3 + 强 → 6 + 强 → 214214 + 强 | 2+HK → 6+HP → 22+PPP | 5800 | 6800 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 7 | 7 | 6 + 弱 + 中 + 强 → 2 + 强 → 214214 + 强 | 6+KKK → 2+HP → 22+PPP | 5800 | 6800 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 2 + 强 → 214214 + 强 | 2+HK → 2+HP → 22+PPP | 5700 | 6700 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 9 | 9 | 6 + 强 → 2 + 强 → 214214 + 强 | 6+HP → 2+HP → 22+PPP | 5700 | 6700 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 10 | 10 | 4 + 强 → 6 + 强 → 214214 + 强 | 4+HP → 6+HP → 22+PPP | 5700 | 6700 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 11 | 11 | 4 + 强 → 2 + 强 → 214214 + 强 | 4+HP → 2+HP → 22+PPP | 5600 | 6600 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 12 | 12 | 2 + 弱 + 中 + 强 → 2 + 中 → 214214 + 强 | 2+KKK → 2+MK → 22+PPP | 5600 | 6600 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 13 | 13 | 强 → 6 + 强 → 214214 + 强 | HK → 6+HP → 22+PPP | 5500 | 6500 | OD 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 14 | 14 | 2 + 中 → 214214 + 强 | 2+MK → 22+PPP | 5500 | 5500 | OD 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs reproduced |
| 15 | 15 | 6 + 弱 + 中 + 强 → 2 + 中 → 214214 + 强 | 6+KKK → 2+MK → 22+PPP | 5500 | 6500 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 16 | 16 | 强 → 2 + 强 → 214214 + 强 | HK → 2+HP → 22+PPP | 5400 | 6400 | OD 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 2 + 中 → 214214 + 强 | 2+HK → 2+MK → 22+PPP | 5400 | 6400 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 18 | 18 | 6 + 强 → 2 + 中 → 214214 + 强 | 6+HP → 2+MK → 22+PPP | 5400 | 6400 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 19 | 19 | 2 + 弱 + 中 + 强 → 2 + 弱 → 214214 + 强 | 2+KKK → 2+LP → 22+PPP | 5400 | 6400 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs reproduced |
| 20 | 20 | 4 + 强 → 2 + 中 → 214214 + 强 | 4+HP → 2+MK → 22+PPP | 5300 | 6300 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/ingrid-modern-plan-max-damage.json  (21 pairs, 44089 bytes)
