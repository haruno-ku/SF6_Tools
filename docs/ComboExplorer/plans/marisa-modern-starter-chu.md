...
Generated 2026-09-14T13:00:59Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 中 → 236236 + 强 | 2+MP → 236236+K | 4700 | 4700 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs verified |
| 2 | 2 | 中 → 2 + 弱 → 236236 + 强 | MK → 2+LP → 236236+K | 4300 | 5100 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs verified |
| 3 | 3 | 2 + 中 → 2 + SP + 强 | 2+MP → 236236+K | 3900 | 4700 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs verified |
| 4 | 4 | 2 + 中 → 214214 + 中 | 2+MP → 214214+P | 3700 | 3700 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 5 | 5 | 中 → 2 + 弱 → 2 + SP + 强 | MK → 2+LP → 236236+K | 3660 | 5100 | SA 1, drive >=0 (1 unknown) | 8.0 | low | 0/2 pairs verified |
| 6 | 6 | 中 → 2 + 弱 → 214214 + 中 | MK → 2+LP → 214214+P | 3500 | 4100 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 7 | 7 | 2 + 中 → 4 + SP + 强 | 2+MP → 214214+P | 3100 | 3700 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs verified |
| 8 | 8 | 中 → 2 + 弱 → 4 + SP + 强 | MK → 2+LP → 214214+P | 3020 | 4100 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs verified |
| 9 | 9 | 2 + 中 → 236236 + 弱 | 2+MP → 236236+P | 2900 | 2900 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 10 | 10 | 中 → 2 + 弱 → 236236 + 弱 | MK → 2+LP → 236236+P | 2860 | 3300 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 11 | 11 | 中 → 2 + 弱 → SP + 强 | MK → 2+LP → 236236+P | 2508 | 3300 | SA 1, drive >=0 (1 unknown) | 7.5 | medium | 0/2 pairs verified |
| 12 | 12 | 中 → 2 + 弱 → 623 + 强 | MK → 2+LP → 623+HP | 2460 | 2800 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 13 | 13 | 2 + 中 → SP + 强 | 2+MP → 236236+P | 2460 | 2900 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs verified |
| 14 | 14 | 2 + 中 → 623 + 强 | 2+MP → 623+HP | 2400 | 2400 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 15 | 15 | 中 → 2 + 弱 → 236 + 强 | MK → 2+LP → 236+HP | 2380 | 2700 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 16 | 16 | 中 → 2 + 弱 → 623 + 中 | MK → 2+LP → 623+MP | 2380 | 2700 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 17 | 17 | 中 → 2 + 弱 → 623 + 弱 | MK → 2+LP → 623+LP | 2300 | 2600 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 18 | 18 | 2 + 中 → 236 + 强 | 2+MP → 236+HP | 2300 | 2300 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 19 | 19 | 2 + 中 → 623 + 中 | 2+MP → 623+MP | 2300 | 2300 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 20 | 20 | 中 → 2 + 弱 → 236 + 中 | MK → 2+LP → 236+MP | 2220 | 2500 | drive 0 | 7.7 | medium | 0/2 pairs verified |
