...
Generated 2026-09-14T13:01:35Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
105 route(s) carry no value on that field and are ranked after the rest, not removed.
...
|---|---|---:|---:|---:|---:|
| no_gauge | true | 1111 | 355 | 756 | 91 |

- routes satisfying every condition: 756
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 中 + 强 → 2 + 强 → 214 + 强 | 2+KK → 2+HP → 214+HP | 2460 | 2700 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 2 | 2 | 2 + 中 + 强 → 2 + 强 → 214 + 中 | 2+KK → 2+HP → 214+MP | 2300 | 2500 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 3 | 3 | 3 + 强 → 2 + 强 → 214 + 强 | 2+HK → 2+HP → 214+HP | 2260 | 2500 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 4 | 4 | 2 + 中 + 强 → 2 + 强 → 214 + 弱 | 2+KK → 2+HP → 214+LP | 2220 | 2400 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 5 | 5 | 2 + 强 → 214 + 强 | 2+HP → 214+HP | 2100 | 2100 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 6 | 6 | 3 + 强 → 2 + 强 → 214 + 中 | 2+HK → 2+HP → 214+MP | 2100 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 7 | 7 | 2 + 中 + 强 → 2 + 强 → 6 + AUTO + SP | 2+KK → 2+HP → 214+LP | 2076 | 2400 | drive 0 | 9.0 | medium | 0/2 pairs verified |
| 8 | 8 | 2 + 中 + 强 → 2 + 中 → 214 + 强 | 2+KK → 2+MK → 214+HP | 2060 | 2300 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 9 | 9 | 3 + 强 → 2 + 强 → 214 + 弱 | 2+HK → 2+HP → 214+LP | 2020 | 2200 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 10 | 10 | 3 + 强 → 2 + 中 + 强 → 214 + 强 | 2+HK → 2+KK → 214+HP | 1960 | 2200 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 11 | 11 | 2 + 中 + 强 → 3 + 强 → 214 + 强 | 2+KK → 2+HK → 214+HP | 1960 | 2200 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 12 | 12 | 2 + 强 → 214 + 中 | 2+HP → 214+MP | 1900 | 1900 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 13 | 13 | 2 + 中 + 强 → 2 + 强 → 623 + 弱 | 2+KK → 2+HP → 623+LK | 1900 | 2000 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 14 | 14 | 2 + 中 + 强 → 2 + 强 → 623 + 中 | 2+KK → 2+HP → 623+MK | 1900 | 2000 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 15 | 15 | 2 + 中 + 强 → 2 + 强 → 623 + 强 | 2+KK → 2+HP → 623+HK | 1900 | 2000 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 16 | 16 | 2 + 中 + 强 → 2 + 中 → 214 + 中 | 2+KK → 2+MK → 214+MP | 1900 | 2100 | drive 0 | 8.7 | medium | 0/2 pairs verified |
| 17 | 17 | 3 + 强 → 2 + 强 → 6 + AUTO + SP | 2+HK → 2+HP → 214+LP | 1876 | 2200 | drive 0 | 8.5 | medium | 0/2 pairs verified |
| 18 | 18 | 3 + 强 → 2 + 中 → 214 + 强 | 2+HK → 2+MK → 214+HP | 1860 | 2100 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 19 | 19 | 2 + 中 + 强 → 2 + 强 → 236 + 强 | 2+KK → 2+HP → 236+HP | 1860 | 1950 | drive 0 | 8.7 | low | 0/2 pairs verified |
| 20 | 20 | 中 → 弱 → 214 + 强 | MP → LP → 214+HP | 1830 | 2070 | drive 0 | 7.2 | low | 0/2 pairs verified |
