...
Generated 2026-09-14T13:03:11Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
| 2 | 2 | 6 + 弱 + 中 + 强 → 6 + 强 → 214214 + 强 | 6+KKK → 6+HP → 22+PPP | 5900 | 6900 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 3 | 3 | 2 + 弱 + 中 + 强 → 2 + 强 → 214214 + 强 | 2+KKK → 2+HP → 22+PPP | 5900 | 6900 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 4 | 4 | 6 + 弱 + 中 + 强 → 2 + 强 → 214214 + 强 | 6+KKK → 2+HP → 22+PPP | 5800 | 6800 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 5 | 5 | 2 + 弱 + 中 + 强 → 2 + 中 → 214214 + 强 | 2+KKK → 2+MK → 22+PPP | 5600 | 6600 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 6 | 6 | 2 + 中 → 214214 + 强 | 2+MK → 22+PPP | 5500 | 5500 | OD 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 7 | 7 | 6 + 弱 + 中 + 强 → 2 + 中 → 214214 + 强 | 6+KKK → 2+MK → 22+PPP | 5500 | 6500 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 8 | 8 | 2 + 弱 + 中 + 强 → 2 + 弱 → 214214 + 强 | 2+KKK → 2+LP → 22+PPP | 5400 | 6400 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 9 | 9 | 6 + 弱 + 中 + 强 → 2 + 弱 → 214214 + 强 | 6+KKK → 2+LP → 22+PPP | 5300 | 6300 | OD 1, drive >=0 (1 unknown) | 11.9 | medium | 0/2 pairs verified |
| 10 | 10 | 6 + 弱 + 中 + 强 → 2 + 弱 + 中 + 强 → 236236 + 强 | 6+KKK → 2+KKK → 236236+P | 5300 | 6100 | SA 1, drive >=0 (1 unknown) | 12.9 | low | 0/2 pairs verified |
| 11 | 11 | 2 + 弱 + 中 + 强 → 6 + 弱 + 中 + 强 → 236236 + 强 | 2+KKK → 6+KKK → 236236+P | 5300 | 6100 | SA 1, drive >=0 (1 unknown) | 12.9 | low | 0/2 pairs verified |
| 12 | 12 | 2 + 弱 + 中 + 强 → 3 + 强 → 236236 + 强 | 2+KKK → 2+HK → 236236+P | 5200 | 6000 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 13 | 13 | 2 + 弱 + 中 + 强 → 6 + 强 → 236236 + 强 | 2+KKK → 6+HP → 236236+P | 5200 | 6000 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 14 | 14 | 6 + 弱 + 中 + 强 → 3 + 强 → 236236 + 强 | 6+KKK → 2+HK → 236236+P | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 15 | 15 | 6 + 弱 + 中 + 强 → 6 + 强 → 236236 + 强 | 6+KKK → 6+HP → 236236+P | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 16 | 16 | 2 + 弱 + 中 + 强 → 236236 + 强 | 2+KKK → 236236+P | 5100 | 5100 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/1 pairs verified |
| 17 | 17 | 2 + 弱 + 中 + 强 → 2 + 强 → 236236 + 强 | 2+KKK → 2+HP → 236236+P | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 18 | 18 | 2 + 弱 + 中 + 强 → 4 + 强 → 236236 + 强 | 2+KKK → 4+HP → 236236+P | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 11.9 | low | 0/2 pairs verified |
| 19 | 19 | 4 + 中 → 2 + 弱 → 214214 + 强 | 4+MK → 2+LP → 22+PPP | 5000 | 6000 | OD 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs verified |
| 20 | 20 | 6 + 弱 + 中 + 强 → 236236 + 强 | 6+KKK → 236236+P | 5000 | 5000 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/1 pairs verified |
...
- reframework/data/ComboExplorer_data/worklist/ingrid-modern-plan-starter-chu.json  (24 pairs, 13464 bytes)
