...
Generated 2026-09-16T02:36:30Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 236236 + 强 | 2+HK → 236236+P | 4900 | 4900 | SA 1, drive >=0 (2 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 2 | 2 | 3 + 强 → 2 + 强 → 236236 + 强 | 2+HK → 2+HP → 236236+P | 4900 | 5700 | SA 1, drive >=0 (3 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 3 | 3 | 2 + 强 → 236236 + 强 | 2+HP → 236236+P | 4800 | 4800 | SA 1, drive >=0 (2 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 4 | 4 | 3 + 强 → 6 + 中 → 236236 + 强 | 2+HK → 6+MP → 236236+P | 4700 | 5500 | SA 1, drive >=0 (2 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 5 | 5 | 6 + 中 → 3 + 强 → 236236 + 强 | 6+MP → 2+HK → 236236+P | 4700 | 5500 | SA 1, drive >=0 (2 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 2 + 中 → 236236 + 强 | 2+HK → 2+MK → 236236+P | 4600 | 5400 | SA 1, drive >=0 (3 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 7 | 7 | 6 + 中 → 236236 + 强 | 6+MP → 236236+P | 4600 | 4600 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 8 | 8 | 6 + 中 → 2 + 强 → 236236 + 强 | 6+MP → 2+HP → 236236+P | 4600 | 5400 | SA 1, drive >=0 (2 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 9 | 9 | 2 + 中 → 236236 + 强 | 2+MK → 236236+P | 4500 | 4500 | SA 1, drive >=0 (2 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 10 | 10 | 3 + 强 → 弱 → 236236 + 强 | 2+HK → LP → 236236+P | 4400 | 5200 | SA 1, drive >=0 (3 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 2 + 弱 → 236236 + 强 | 2+HK → 2+LP → 236236+P | 4400 | 5200 | SA 1, drive >=0 (3 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 12 | 12 | 6 + 中 → 2 + 中 → 236236 + 强 | 6+MP → 2+MK → 236236+P | 4300 | 5100 | SA 1, drive >=0 (2 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 2 + 强 → 2 + SP + 强 | 2+HK → 2+HP → 236236+P | 4260 | 5700 | SA 1, drive >=0 (3 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 2 + SP + 强 | 2+HK → 236236+P | 4100 | 4900 | SA 1, drive >=0 (2 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 15 | 15 | 6 + 中 → 弱 → 236236 + 强 | 6+MP → LP → 236236+P | 4100 | 4900 | SA 1, drive >=0 (2 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 16 | 16 | 6 + 中 → 2 + 弱 → 236236 + 强 | 6+MP → 2+LP → 236236+P | 4100 | 4900 | SA 1, drive >=0 (2 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 6 + 中 → 2 + SP + 强 | 2+HK → 6+MP → 236236+P | 4060 | 5500 | SA 1, drive >=0 (2 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 18 | 18 | 6 + 中 → 3 + 强 → 2 + SP + 强 | 6+MP → 2+HK → 236236+P | 4060 | 5500 | SA 1, drive >=0 (2 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 19 | 19 | 2 + 强 → 2 + SP + 强 | 2+HP → 236236+P | 4000 | 4800 | SA 1, drive >=0 (2 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 20 | 20 | 3 + 强 → 2 + 中 → 2 + SP + 强 | 2+HK → 2+MK → 236236+P | 3960 | 5400 | SA 1, drive >=0 (3 unknown) | 8.5 | low | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/yasmine-modern-plan-max-damage.json  (20 pairs, 42037 bytes)
