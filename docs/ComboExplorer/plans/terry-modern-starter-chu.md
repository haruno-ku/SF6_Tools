...
Generated 2026-09-16T02:34:53Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 中 → 236236 + 强 | MP → 236236+P | 4700 | 4700 | SA 1, drive >=0 (1 unknown) | 8.4 | low | 0/1 pairs reproduced |
| 2 | 2 | 2 + 中 → 236236 + 强 | 2+MK → 236236+P | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 3 | 3 | 中 → 2 + SP + 强 | MP → 236236+P | 3900 | 4700 | SA 1, drive >=0 (1 unknown) | 6.0 | low | 0/1 pairs reproduced |
| 4 | 4 | 2 + 中 → 2 + SP + 强 | 2+MK → 236236+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 5 | 5 | 中 → 214214 + 中 | MP → 214214+P | 3300 | 3300 | SA 1, drive >=0 (1 unknown) | 8.4 | high | 0/1 pairs reproduced |
| 6 | 6 | 2 + 中 → 214214 + 中 | 2+MK → 214214+P | 3100 | 3100 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs reproduced |
| 7 | 7 | 中 → 4 + SP + 强 | MP → 214214+P | 2780 | 3300 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs reproduced |
| 8 | 8 | 中 → 236236 + 弱 | MP → 236236+K | 2700 | 2700 | SA 1, drive >=0 (1 unknown) | 8.4 | high | 0/1 pairs reproduced |
| 9 | 9 | 2 + 中 → 4 + SP + 强 | 2+MK → 214214+P | 2580 | 3100 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs reproduced |
| 10 | 10 | 2 + 中 → 236236 + 弱 | 2+MK → 236236+K | 2500 | 2500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs reproduced |
| 11 | 11 | 中 → SP + 强 | MP → 236236+K | 2300 | 2700 | SA 1, drive >=0 (1 unknown) | 5.5 | high | 0/1 pairs reproduced |
| 12 | 12 | 中 → 214 + 中 + 强 | MP → 214+MP+HP | 2100 | 2100 | drive 20000 | 6.2 | high | 0/1 pairs reproduced |
| 13 | 13 | 2 + 中 → SP + 强 | 2+MK → 236236+K | 2100 | 2500 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs reproduced |
| 14 | 14 | 中 → 214 + 强 | MP → 214+HP | 1900 | 1900 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 15 | 15 | 2 + 中 → 214 + 中 + 强 | 2+MK → 214+MP+HP | 1900 | 1900 | drive 20000 | 6.7 | high | 0/1 pairs reproduced |
| 16 | 16 | 中 → 214 + 中 | MP → 214+MP | 1700 | 1700 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 17 | 17 | 中 → 623 + 弱 | MP → 623+LP | 1700 | 1700 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 18 | 18 | 2 + 中 → 214 + 强 | 2+MK → 214+HP | 1700 | 1700 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 19 | 19 | 中 → 4 + AUTO + SP | MP → 214+KK | 1660 | 1900 | OD 1, drive 20000 | 6.0 | high | 0/1 pairs reproduced |
| 20 | 20 | 中 → 236 + 强 | MP → 236+HP | 1600 | 1600 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/terry-modern-plan-starter-chu.json  (20 pairs, 38171 bytes)
