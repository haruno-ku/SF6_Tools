...
Generated 2026-09-16T02:17:49Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
| 2 | 2 | 6 或 4 + 中 → 214214 + 强 | 6+MP → 214214+K | 4600 | 4600 | SA 1, drive >=0 (1 unknown) | 10.2 | low | 0/1 pairs reproduced |
| 3 | 3 | 2 + 中 → 214214 + 强 | 2+MK → 214214+K | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 4 | 4 | 中 → 2 + SP + 强 | MP → 214214+K | 3800 | 4600 | SA 1, drive >=0 (1 unknown) | 6.0 | low | 0/1 pairs reproduced |
| 5 | 5 | 6 或 4 + 中 → 2 + SP + 强 | 6+MP → 214214+K | 3800 | 4600 | SA 1, drive >=0 (1 unknown) | 7.8 | low | 0/1 pairs reproduced |
| 6 | 6 | 2 + 中 → 2 + SP + 强 | 2+MK → 214214+K | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 7 | 7 | 中 → 中 → 236236 + 中 | MP → MP → 236236+K | 2800 | 3200 | SA 1, drive >=0 (1 unknown) | 9.9 | medium | 0/2 pairs reproduced |
| 8 | 8 | 中 → 236236 + 中 | MP → 236236+K | 2600 | 2600 | SA 1, drive >=0 (1 unknown) | 8.4 | high | 0/1 pairs reproduced |
| 9 | 9 | 6 或 4 + 中 → 236236 + 中 | 6+MP → 236236+K | 2600 | 2600 | SA 1, drive >=0 (1 unknown) | 10.2 | high | 0/1 pairs reproduced |
| 10 | 10 | 中 → 弱 → 236236 + 中 | MP → LP → 236236+K | 2500 | 2900 | SA 1, drive >=0 (1 unknown) | 9.9 | medium | 0/2 pairs reproduced |
| 11 | 11 | 中 → 2 + 弱 → 236236 + 中 | MP → 2+LP → 236236+K | 2500 | 2900 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs reproduced |
| 12 | 12 | 2 + 中 → 236236 + 中 | 2+MK → 236236+K | 2500 | 2500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs reproduced |
| 13 | 13 | 中 → 中 → 4 + SP + 强 | MP → MP → 236236+K | 2480 | 3200 | SA 1, drive >=0 (1 unknown) | 7.5 | medium | 0/2 pairs reproduced |
| 14 | 14 | 2 + 中 → 弱 → 236236 + 中 | MK → LP → 236236+K | 2400 | 2800 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs reproduced |
| 15 | 15 | 2 + 中 → 2 + 弱 → 236236 + 中 | MK → 2+LP → 236236+K | 2400 | 2800 | SA 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 16 | 16 | 中 → 4 + SP + 强 | MP → 236236+K | 2200 | 2600 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs reproduced |
| 17 | 17 | 6 或 4 + 中 → 4 + SP + 强 | 6+MP → 236236+K | 2200 | 2600 | SA 1, drive >=0 (1 unknown) | 7.8 | high | 0/1 pairs reproduced |
| 18 | 18 | 中 → 弱 → 4 + SP + 强 | MP → LP → 236236+K | 2180 | 2900 | SA 1, drive >=0 (1 unknown) | 7.5 | medium | 0/2 pairs reproduced |
| 19 | 19 | 中 → 2 + 弱 → 4 + SP + 强 | MP → 2+LP → 236236+K | 2180 | 2900 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs reproduced |
| 20 | 20 | 2 + 中 → 4 + SP + 强 | 2+MK → 236236+K | 2100 | 2500 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/chunli-modern-plan-starter-chu.json  (23 pairs, 42250 bytes)
