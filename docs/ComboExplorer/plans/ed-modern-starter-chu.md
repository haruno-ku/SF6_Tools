...
Generated 2026-09-16T02:32:26Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
| 2 | 2 | 2 + 中 → 236236 + 强 | 2+MP → 236236+P | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 3 | 3 | 中 → 2 + SP + 强 | MK → 236236+P | 3800 | 4600 | SA 1, drive >=0 (1 unknown) | 6.0 | low | 0/1 pairs reproduced |
| 4 | 4 | 2 + 中 → 2 + SP + 强 | 2+MP → 236236+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 5 | 5 | 中 → 623 + 强 | MK → 623+HP | 1800 | 1800 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 6 | 6 | 2 + 中 → 623 + 强 | 2+MP → 623+HP | 1700 | 1700 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 7 | 7 | 中 → 623 + 中 | MK → 623+MP | 1600 | 1600 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 8 | 8 | 中 → 236 + 中 | MK → 236+MK | 1500 | 1500 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 9 | 9 | 中 → 623 + 弱 | MK → 623+LP | 1500 | 1500 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 10 | 10 | 2 + 中 → 623 + 中 | 2+MP → 623+MP | 1500 | 1500 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 11 | 11 | 中 → 236 + 弱 | MK → 236+LK | 1400 | 1400 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 12 | 12 | 中 → 236 + 强 | MK → 236+HK | 1400 | 1400 | drive 0 | 5.7 | high | 0/1 pairs reproduced |
| 13 | 13 | 2 + 中 → 236 + 中 | 2+MP → 236+MK | 1400 | 1400 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 14 | 14 | 2 + 中 → 623 + 弱 | 2+MP → 623+LP | 1400 | 1400 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 15 | 15 | 中 → 6 + SP | MK → 623+LP | 1320 | 1500 | drive 0 | 5.5 | high | 0/1 pairs reproduced |
| 16 | 16 | 2 + 中 → 236 + 弱 | 2+MP → 236+LK | 1300 | 1300 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 17 | 17 | 2 + 中 → 236 + 强 | 2+MP → 236+HK | 1300 | 1300 | drive 0 | 6.2 | high | 0/1 pairs reproduced |
| 18 | 18 | 中 → 2 + SP | MK → 236+LK | 1240 | 1400 | drive 0 | 5.5 | high | 0/1 pairs reproduced |
| 19 | 19 | 中 → 6 + AUTO + SP | MK → 623+PP | 1240 | 1400 | OD 1, drive 20000 | 6.0 | high | 0/1 pairs reproduced |
| 20 | 20 | 2 + 中 → 6 + SP | 2+MP → 623+LP | 1220 | 1400 | drive 0 | 6.0 | high | 0/1 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/ed-modern-plan-starter-chu.json  (20 pairs, 38071 bytes)
