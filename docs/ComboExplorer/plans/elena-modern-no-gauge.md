...
Generated 2026-09-16T02:35:23Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 中 → 623 + 弱 | 2+HK → MK → 623+LK | 2200 | 2400 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 2 + 强 → 623 + 弱 | 2+HK → 2+HP → 623+LK | 2100 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 弱 → 623 + 弱 | 2+HK → LK → 623+LK | 2000 | 2200 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 2 + 弱 → 623 + 弱 | 2+HK → 2+LP → 623+LK | 2000 | 2200 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 5 | 5 | 3 + 强 → 2 + 弱 → 3 + 强 | 2+HK → 2+LP → 2+HK | 1920 | 2100 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 2 + 弱 → 4 + 强 | 2+HK → 2+LP → 4+HK | 1920 | 2100 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 2 + 弱 → 6 + 强 | 2+HK → 2+LP → 6+HP | 1920 | 2100 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 中 → 4 + SP | 2+HK → MK → 214+LP | 1912 | 2200 | drive 0 | 7.5 | medium | 0/2 pairs reproduced |
| 9 | 9 | 3 + 强 → 623 + 弱 | 2+HK → 623+LK | 1900 | 1900 | drive 0 | 6.2 | medium | 0/1 pairs reproduced |
| 10 | 10 | 3 + 强 → 中 → 623 + 中 | 2+HK → MK → 623+MK | 1880 | 2000 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 2 + 弱 → 强 | 2+HK → 2+LP → HP | 1840 | 2000 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 2 + 强 → 4 + SP | 2+HK → 2+HP → 214+LP | 1812 | 2100 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 中 → 623 + 强 | 2+HK → MK → 623+HK | 1800 | 1900 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 4 + 强 | 2+HK → 4+HK | 1800 | 1800 | drive 0 | 4.0 | medium | 0/1 pairs reproduced |
| 15 | 15 | 3 + 强 → 6 + 强 | 2+HK → 6+HP | 1800 | 1800 | drive 0 | 4.0 | medium | 0/1 pairs reproduced |
| 16 | 16 | 3 + 强 → 中 → 6 + SP | 2+HK → MK → 623+MK | 1784 | 2000 | drive 0 | 7.5 | medium | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 2 + 强 → 623 + 中 | 2+HK → 2+HP → 623+MK | 1780 | 1900 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 2 + 中 → 2 + 弱 | 2+HK → 2+MK → 2+LP | 1740 | 1800 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 19 | 19 | 2 + 弱 → 3 + 强 → 623 + 弱 | 2+LP → 2+HK → 623+LK | 1720 | 2200 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 20 | 20 | 3 + 强 → 中 → 236 + 弱 | 2+HK → MK → 236+LK | 1720 | 1800 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/elena-modern-plan-no-gauge.json  (24 pairs, 45430 bytes)
