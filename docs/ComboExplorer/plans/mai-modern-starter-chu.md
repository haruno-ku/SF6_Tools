...
Generated 2026-09-16T02:34:36Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 中 → 214214 + 强 | 2+MK → 214214+P | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 2 | 2 | 中 → 弱 → 214214 + 强 | MK → LK → 214214+P | 4200 | 5000 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/2 pairs reproduced |
| 3 | 3 | 中 → 2 + 弱 → 214214 + 强 | MK → 2+LP → 214214+P | 4200 | 5000 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 4 | 4 | 2 + 中 → 2 + SP + 强 | 2+MK → 214214+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs reproduced |
| 5 | 5 | 中 → 弱 → 2 + SP + 强 | MK → LK → 214214+P | 3560 | 5000 | SA 1, drive >=0 (1 unknown) | 7.5 | low | 0/2 pairs reproduced |
| 6 | 6 | 中 → 2 + 弱 → 2 + SP + 强 | MK → 2+LP → 214214+P | 3560 | 5000 | SA 1, drive >=0 (1 unknown) | 8.0 | low | 0/2 pairs reproduced |
| 7 | 7 | 中 → 2 + 弱 → 强 | MK → 2+LP → HK | 1720 | 1900 | drive 0 | 5.0 | medium | 0/2 pairs reproduced |
| 8 | 8 | 中 → 2 + 弱 → 3 + 强 | MK → 2+LP → 2+HK | 1720 | 1900 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 9 | 9 | 中 → 弱 → 214 + 弱 | MK → LK → 214+LP | 1640 | 1800 | drive 0 | 7.2 | low | 0/2 pairs reproduced |
| 10 | 10 | 中 → 2 + 弱 → 214 + 弱 | MK → 2+LP → 214+LP | 1640 | 1800 | drive 0 | 7.7 | low | 0/2 pairs reproduced |
| 11 | 11 | 中 → 2 + 弱 → 4 + 强 | MK → 2+LP → 4+HK | 1640 | 1800 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 12 | 12 | 中 → 2 + 弱 → 中 | MK → 2+LP → MK | 1560 | 1700 | drive 0 | 5.0 | medium | 0/2 pairs reproduced |
| 13 | 13 | 中 → 弱 → 4 + SP | MK → LK → 214+LP | 1512 | 1800 | drive 0 | 7.0 | low | 0/2 pairs reproduced |
| 14 | 14 | 中 → 弱 → 6 + AUTO + SP | MK → LK → 623+KK | 1512 | 1800 | OD 1, drive 20000 | 7.5 | low | 0/2 pairs reproduced |
| 15 | 15 | 中 → 2 + 弱 → 4 + SP | MK → 2+LP → 214+LP | 1512 | 1800 | drive 0 | 7.5 | low | 0/2 pairs reproduced |
| 16 | 16 | 中 → 2 + 弱 → 6 + AUTO + SP | MK → 2+LP → 623+KK | 1512 | 1800 | OD 1, drive 20000 | 8.0 | low | 0/2 pairs reproduced |
| 17 | 17 | 中 → 弱 → 623 + 强 | MK → LK → 623+HK | 1480 | 1600 | drive 0 | 7.2 | low | 0/2 pairs reproduced |
| 18 | 18 | 中 → 2 + 弱 → 623 + 强 | MK → 2+LP → 623+HK | 1480 | 1600 | drive 0 | 7.7 | low | 0/2 pairs reproduced |
| 19 | 19 | 中 → 2 + 弱 → 6 + 中 | MK → 2+LP → 6+MP | 1480 | 1600 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 20 | 20 | 中 → 弱 → 623 + 中 | MK → LK → 623+MK | 1400 | 1500 | drive 0 | 7.2 | low | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/mai-modern-plan-starter-chu.json  (22 pairs, 44825 bytes)
