...
Generated 2026-09-16T02:36:38Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 6 + 中 → 3 + 强 | 2+HK → 6+MP → 2+HK | 2220 | 2400 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 6 + 中 → 强 | 2+HK → 6+MP → HK | 2140 | 2300 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 6 + 中 → 2 + 强 | 2+HK → 6+MP → 2+HP | 2140 | 2300 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 4 | 4 | 6 + 中 → 3 + 强 → 强 | 6+MP → 2+HK → HK | 2140 | 2300 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 5 | 5 | 6 + 中 → 3 + 强 → 2 + 强 | 6+MP → 2+HK → 2+HP | 2140 | 2300 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 6 | 6 | 6 + 中 → 3 + 强 → 6 + 中 | 6+MP → 2+HK → 6+MP | 1980 | 2100 | drive >=0 (1 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 2 + 弱 → 3 + 强 | 2+HK → 2+LP → 2+HK | 1920 | 2100 | drive >=0 (3 unknown) | 6.0 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 6 + 中 → 2 + 中 | 2+HK → 6+MP → 2+MK | 1900 | 2000 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 9 | 9 | 6 + 中 → 3 + 强 → 2 + 中 | 6+MP → 2+HK → 2+MK | 1900 | 2000 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 10 | 10 | 3 + 强 → 2 + 弱 → 强 | 2+HK → 2+LP → HK | 1840 | 2000 | drive >=0 (3 unknown) | 5.5 | medium | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 2 + 弱 → 2 + 强 | 2+HK → 2+LP → 2+HP | 1840 | 2000 | drive >=0 (3 unknown) | 6.0 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 6 + 中 → 弱 | 2+HK → 6+MP → LP | 1740 | 1800 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 6 + 中 → 中 | 2+HK → 6+MP → MP | 1740 | 1800 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 6 + 中 → 2 + 弱 | 2+HK → 6+MP → 2+LP | 1740 | 1800 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 15 | 15 | 6 + 中 → 3 + 强 → 弱 | 6+MP → 2+HK → LP | 1740 | 1800 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 16 | 16 | 6 + 中 → 3 + 强 → 中 | 6+MP → 2+HK → MP | 1740 | 1800 | drive >=0 (2 unknown) | 5.5 | low | 0/2 pairs reproduced |
| 17 | 17 | 6 + 中 → 3 + 强 → 2 + 弱 | 6+MP → 2+HK → 2+LP | 1740 | 1800 | drive >=0 (2 unknown) | 6.0 | low | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 强 | 2+HK → HK | 1700 | 1700 | drive >=0 (2 unknown) | 3.5 | medium | 0/1 pairs reproduced |
| 19 | 19 | 3 + 强 → 2 + 强 | 2+HK → 2+HP | 1700 | 1700 | drive >=0 (2 unknown) | 4.0 | medium | 0/1 pairs reproduced |
| 20 | 20 | 3 + 强 → 2 + 弱 → 6 + 中 | 2+HK → 2+LP → 6+MP | 1680 | 1800 | drive >=0 (2 unknown) | 6.0 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/yasmine-modern-plan-no-gauge.json  (18 pairs, 41635 bytes)
