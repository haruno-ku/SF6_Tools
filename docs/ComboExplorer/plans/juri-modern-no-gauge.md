...
Generated 2026-09-16T02:26:55Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 3 + 强 → 强 | 2+HK → 2+HK → HK | 2520 | 2700 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 3 + 强 → 2 + 强 | 2+HK → 2+HK → 2+HP | 2520 | 2700 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 3 + 强 → 3 + 强 | 2+HK → 2+HK → 2+HK | 2520 | 2700 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 2 + 强 → 214 + 弱 | 2+HK → 2+HP → 214+LK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 5 | 5 | 3 + 强 → 2 + 强 → 214 + 中 | 2+HK → 2+HP → 214+MK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 2 + 强 → 236 + 中 | 2+HK → 2+HP → 236+MK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 3 + 强 → 中 | 2+HK → 2+HK → MP | 2280 | 2400 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 3 + 强 → 6 + 中 | 2+HK → 2+HK → 6+MK | 2280 | 2400 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 9 | 9 | 3 + 强 → 3 + 强 → 214 + 弱 | 2+HK → 2+HK → 214+LK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 10 | 10 | 3 + 强 → 3 + 强 → 214 + 中 | 2+HK → 2+HK → 214+MK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 3 + 强 → 236 + 中 | 2+HK → 2+HK → 236+MK | 2280 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 2 + 强 → 214 + 强 | 2+HK → 2+HP → 214+HK | 2200 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 3 + 强 → 2 + 中 | 2+HK → 2+HK → 2+MK | 2200 | 2300 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 3 + 强 → 6 + 强 | 2+HK → 2+HK → 6+HP | 2200 | 2300 | drive 0 | 6.0 | medium | 0/2 pairs reproduced |
| 15 | 15 | 3 + 强 → 3 + 强 → 214 + 强 | 2+HK → 2+HK → 214+HK | 2200 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 2 + 强 → 4 + SP | 2+HK → 2+HP → 214+MK | 2184 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 2 + 强 → 2 + SP | 2+HK → 2+HP → 236+MK | 2184 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 3 + 强 → 4 + SP | 2+HK → 2+HK → 214+MK | 2184 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 19 | 19 | 3 + 强 → 3 + 强 → 2 + SP | 2+HK → 2+HK → 236+MK | 2184 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 20 | 20 | 3 + 强 → 2 + 强 → 236 + 弱 | 2+HK → 2+HP → 236+LK | 2120 | 2200 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/juri-modern-plan-no-gauge.json  (22 pairs, 45408 bytes)
