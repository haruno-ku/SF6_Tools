...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 4 + 强 → 623 + 强 | 2+HK → 4+HK → 623+HK | 2660 | 2900 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 2 | 2 | 3 + 强 → 6 + 强 → 623 + 强 | 2+HK → 6+HK → 623+HK | 2660 | 2900 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 3 | 3 | 4 + 强 → 3 + 强 → 623 + 强 | 4+HK → 2+HK → 623+HK | 2660 | 2900 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 4 | 4 | 6 + 强 → 3 + 强 → 623 + 强 | 6+HK → 2+HK → 623+HK | 2660 | 2900 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 5 | 5 | 3 + 强 → 2 + 强 → 623 + 强 | 2+HK → 2+HP → 623+HK | 2560 | 2800 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 6 | 6 | 4 + 强 → 6 + 强 → 623 + 强 | 4+HK → 6+HK → 623+HK | 2560 | 2800 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 7 | 7 | 6 + 强 → 4 + 强 → 623 + 强 | 6+HK → 4+HK → 623+HK | 2560 | 2800 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 8 | 8 | 3 + 强 → 4 + 强 → 623 + 中 | 2+HK → 4+HK → 623+MK | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 9 | 9 | 3 + 强 → 6 + 强 → 623 + 中 | 2+HK → 6+HK → 623+MK | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 10 | 10 | 4 + 强 → 3 + 强 → 623 + 中 | 4+HK → 2+HK → 623+MK | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 11 | 11 | 6 + 强 → 3 + 强 → 623 + 中 | 6+HK → 2+HK → 623+MK | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 12 | 12 | 4 + 强 → 2 + 强 → 623 + 强 | 4+HK → 2+HP → 623+HK | 2460 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 13 | 13 | 6 + 强 → 2 + 强 → 623 + 强 | 6+HK → 2+HP → 623+HK | 2460 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 14 | 14 | 3 + 强 → 4 + 强 → 强 | 2+HK → 4+HK → HK | 2420 | 2600 | drive 0 | 5.5 | medium | 0/2 pairs verified |
| 15 | 15 | 3 + 强 → 4 + 强 → 3 + 强 | 2+HK → 4+HK → 2+HK | 2420 | 2600 | drive 0 | 6.0 | medium | 0/2 pairs verified |
| 16 | 16 | 3 + 强 → 4 + 强 → 236 + 中 | 2+HK → 4+HK → 236+MK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 17 | 17 | 3 + 强 → 4 + 强 → 623 + 弱 | 2+HK → 4+HK → 623+LK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 18 | 18 | 3 + 强 → 6 + 强 → 强 | 2+HK → 6+HK → HK | 2420 | 2600 | drive 0 | 5.5 | medium | 0/2 pairs verified |
| 19 | 19 | 3 + 强 → 6 + 强 → 3 + 强 | 2+HK → 6+HK → 2+HK | 2420 | 2600 | drive 0 | 6.0 | medium | 0/2 pairs verified |
| 20 | 20 | 3 + 强 → 6 + 强 → 236 + 中 | 2+HK → 6+HK → 236+MK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs verified |
