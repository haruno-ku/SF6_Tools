...
Generated 2026-09-14T13:01:48Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
70 route(s) carry no value on that field and are ranked after the rest, not removed.
...
- routes found by the search: 1111 (search complete: false)
  - the beam dropped 56 partial routes and 0 routes were not emitted, so a route
    satisfying these conditions may be missing

| condition | value | before | removed | after | kept on a gap |
|---|---|---:|---:|---:|---:|
| starter_button | M | 1111 | 729 | 382 | 0 |

- routes satisfying every condition: 382
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 中 + 强 → 236236 + 强 | 2+KK → 236236+P | 5100 | 5100 | SA 1, drive >=0 (1 unknown) | 9.4 | low | 0/1 pairs verified |
| 2 | 2 | 2 + 中 + 强 → 2 + 强 → 236236 + 强 | 2+KK → 2+HP → 236236+P | 5100 | 6000 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 3 | 3 | 2 + 中 + 强 → 6 + 强 → 236236 + 强 | 2+KK → 6+HK → 236236+P | 5100 | 6000 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 4 | 4 | 2 + 中 → 236236 + 强 | 2+MK → 236236+P | 5000 | 5000 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs verified |
| 5 | 5 | 2 + 中 + 强 → 4 + 强 → 236236 + 强 | 2+KK → 4+HP → 236236+P | 5000 | 5900 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 6 | 6 | 2 + 中 + 强 → 2 + 中 → 236236 + 强 | 2+KK → 2+MK → 236236+P | 4700 | 5600 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 7 | 7 | 2 + 中 + 强 → 3 + 强 → 236236 + 强 | 2+KK → 2+HK → 236236+P | 4600 | 5500 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 8 | 8 | 中 → 弱 → 236236 + 强 | MP → LP → 236236+P | 4470 | 5370 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/2 pairs verified |
| 9 | 9 | 2 + 中 + 强 → 弱 → 236236 + 强 | 2+KK → LP → 236236+P | 4470 | 5370 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs verified |
| 10 | 10 | 中 → 2 + 弱 → 236236 + 强 | MP → 2+LP → 236236+P | 4450 | 5350 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs verified |
| 11 | 11 | 2 + 中 + 强 → 2 + 弱 → 236236 + 强 | 2+KK → 2+LP → 236236+P | 4450 | 5350 | SA 1, drive >=0 (1 unknown) | 11.4 | low | 0/2 pairs verified |
| 12 | 12 | 2 + 中 + 强 → 2 + 强 → 2 + SP + 强 | 2+KK → 2+HP → 236236+P | 4380 | 6000 | SA 1, drive >=0 (1 unknown) | 9.0 | low | 0/2 pairs verified |
| 13 | 13 | 2 + 中 + 强 → 6 + 强 → 2 + SP + 强 | 2+KK → 6+HK → 236236+P | 4380 | 6000 | SA 1, drive >=0 (1 unknown) | 9.0 | low | 0/2 pairs verified |
| 14 | 14 | 中 → 强 → 236236 + 强 | MP → HP → 236236+P | 4300 | 5200 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/2 pairs verified |
| 15 | 15 | 2 + 中 + 强 → 强 → 236236 + 强 | 2+KK → HP → 236236+P | 4300 | 5200 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs verified |
| 16 | 16 | 2 + 中 + 强 → 4 + 强 → 2 + SP + 强 | 2+KK → 4+HP → 236236+P | 4280 | 5900 | SA 1, drive >=0 (1 unknown) | 9.0 | low | 0/2 pairs verified |
| 17 | 17 | 2 + 中 + 强 → 2 + SP + 强 | 2+KK → 236236+P | 4200 | 5100 | SA 1, drive >=0 (1 unknown) | 7.0 | low | 0/1 pairs verified |
| 18 | 18 | 2 + 中 → 2 + SP + 强 | 2+MK → 236236+P | 4100 | 5000 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs verified |
| 19 | 19 | 2 + 中 + 强 → 2 + 中 → 2 + SP + 强 | 2+KK → 2+MK → 236236+P | 3980 | 5600 | SA 1, drive >=0 (1 unknown) | 9.0 | low | 0/2 pairs verified |
| 20 | 20 | 2 + 中 + 强 → 3 + 强 → 2 + SP + 强 | 2+KK → 2+HK → 236236+P | 3880 | 5500 | SA 1, drive >=0 (1 unknown) | 9.0 | low | 0/2 pairs verified |

## Pairs to sweep: 26

In the order the worklist holds them. `needed by` lists the plan ranks of the
routes containing the pair. The full worklist has 824 pairs.
