...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 2 + 强 → 214 + 强 | 2+HK → 2+HP → 214+HP | 2660 | 2900 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 中 → 214 + 强 | 2+HK → MP → 214+HP | 2560 | 2800 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 2 + 强 → 214 + 中 | 2+HK → 2+HP → 214+MP | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 2 + 强 → 623 + 弱 | 2+HK → 2+HP → 623+LP | 2500 | 2700 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 5 | 5 | 3 + 强 → 2 + 强 → 236 + 强 | 2+HK → 2+HP → 236+HP | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 中 → 214 + 中 | 2+HK → MP → 214+MP | 2400 | 2600 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 中 → 623 + 弱 | 2+HK → MP → 623+LP | 2400 | 2600 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 2 + 中 → 214 + 强 | 2+HK → 2+MK → 214+HP | 2360 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 9 | 9 | 3 + 强 → 2 + 强 → 6 + SP | 2+HK → 2+HP → 623+LP | 2340 | 2700 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 10 | 10 | 3 + 强 → 中 → 236 + 强 | 2+HK → MP → 236+HP | 2320 | 2500 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 2 + 强 → 236 + 中 | 2+HK → 2+HP → 236+MP | 2260 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 2 + 强 → 623 + 强 | 2+HK → 2+HP → 623+HP | 2260 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 中 → 6 + SP | 2+HK → MP → 623+LP | 2240 | 2600 | drive 0 | 7.5 | medium | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 2 + 强 → 2 + SP | 2+HK → 2+HP → 236+MK | 2212 | 2500 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 15 | 15 | 3 + 强 → 2 + 强 → 3 + SP | 2+HK → 2+HP → 236+HK | 2212 | 2500 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 2 + 中 → 214 + 中 | 2+HK → 2+MK → 214+MP | 2200 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 2 + 中 → 623 + 弱 | 2+HK → 2+MK → 623+LP | 2200 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 2 + 强 → 236 + 弱 | 2+HK → 2+HP → 236+LP | 2180 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 19 | 19 | 3 + 强 → 2 + 强 → 623 + 中 | 2+HK → 2+HP → 623+MP | 2180 | 2300 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 20 | 20 | 3 + 强 → 弱 → 214 + 强 | 2+HK → LP → 214+HP | 2160 | 2400 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
