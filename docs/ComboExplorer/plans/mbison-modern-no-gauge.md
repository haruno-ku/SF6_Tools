...
Generated 2026-09-14T13:02:06Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 2 + 强 → [4]6 + 强 | 2+HK → 2+HP → [4]6+HP | 3080 | 3400 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 2 | 2 | 3 + 强 → 4 + 强 → [4]6 + 强 | 2+HK → 4+HK → [4]6+HP | 2980 | 3300 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 3 | 3 | 3 + 强 → 2 + 强 → [4]6 + 中 | 2+HK → 2+HP → [4]6+MP | 2920 | 3200 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 4 | 4 | 3 + 强 → 4 + 强 → [4]6 + 中 | 2+HK → 4+HK → [4]6+MP | 2820 | 3100 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 5 | 5 | 3 + 强 → 2 + 强 → [4]6 + 弱 | 2+HK → 2+HP → [4]6+LP | 2760 | 3000 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 6 | 6 | 3 + 强 → 2 + 中 → [4]6 + 强 | 2+HK → 2+MK → [4]6+HP | 2680 | 3000 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 7 | 7 | 3 + 强 → 4 + 强 → [4]6 + 弱 | 2+HK → 4+HK → [4]6+LP | 2660 | 2900 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 8 | 8 | 强 → 弱 → [4]6 + 强 | HP → LP → [4]6+HP | 2580 | 2900 | drive 0 | 6.3 | low | 0/2 pairs verified |
| 9 | 9 | 强 → 2 + 弱 → [4]6 + 强 | HP → 2+LP → [4]6+HP | 2580 | 2900 | drive 0 | 6.8 | low | 0/2 pairs verified |
| 10 | 10 | 3 + 强 → 2 + 强 → [4] + SP | 2+HK → 2+HP → [4]6+LP | 2568 | 3000 | drive 0 | 8.0 | low | 0/2 pairs verified |
| 11 | 11 | 3 + 强 → 2 + 中 → [4]6 + 中 | 2+HK → 2+MK → [4]6+MP | 2520 | 2800 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 12 | 12 | 2 + 强 → [4]6 + 强 | 2+HP → [4]6+HP | 2500 | 2500 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 13 | 13 | 3 + 强 → [4]6 + 强 | 2+HK → [4]6+HP | 2500 | 2500 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 14 | 14 | 3 + 强 → 弱 → [4]6 + 强 | 2+HK → LP → [4]6+HP | 2480 | 2800 | drive 0 | 6.8 | low | 0/2 pairs verified |
| 15 | 15 | 3 + 强 → 2 + 弱 → [4]6 + 强 | 2+HK → 2+LP → [4]6+HP | 2480 | 2800 | drive 0 | 7.3 | low | 0/2 pairs verified |
| 16 | 16 | 3 + 强 → 4 + 强 → [4] + SP | 2+HK → 4+HK → [4]6+LP | 2468 | 2900 | drive 0 | 8.0 | low | 0/2 pairs verified |
| 17 | 17 | 强 → 弱 → [4]6 + 中 | HP → LP → [4]6+MP | 2420 | 2700 | drive 0 | 6.3 | low | 0/2 pairs verified |
| 18 | 18 | 强 → 2 + 弱 → [4]6 + 中 | HP → 2+LP → [4]6+MP | 2420 | 2700 | drive 0 | 6.8 | low | 0/2 pairs verified |
| 19 | 19 | 4 + 强 → [4]6 + 强 | 4+HK → [4]6+HP | 2400 | 2400 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 20 | 20 | 4 + 强 → 2 + 弱 → [4]6 + 强 | 4+HK → 2+LP → [4]6+HP | 2380 | 2700 | drive 0 | 7.3 | low | 0/2 pairs verified |
...
- reframework/data/ComboExplorer_data/worklist/mbison-modern-plan-no-gauge.json  (23 pairs, 13042 bytes)
