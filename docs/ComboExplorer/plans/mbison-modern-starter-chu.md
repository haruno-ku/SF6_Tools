...
Generated 2026-09-14T13:02:11Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
| 2 | 2 | 2 + 中 → 2 + SP + 强 | 2+MK → 236236+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs verified |
| 3 | 3 | 2 + 中 → 214214 + 中 | 2+MK → 214214+K | 3500 | 3500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 4 | 4 | 2 + 中 → 22 + 弱 + 中 + 强 | 2+MK → 214214+P | 3500 | 3500 | SA 1, drive >=0 (1 unknown) | 6.3 | high | 0/1 pairs verified |
| 5 | 5 | 2 + 中 → 4 + SP + 强 | 2+MK → 214214+K | 2900 | 3500 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs verified |
| 6 | 6 | 2 + 中 → 236236 + 弱 | 2+MK → 236236+K | 2500 | 2500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 7 | 7 | 2 + 中 → [4]6 + 强 | 2+MK → [4]6+HP | 2100 | 2100 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 8 | 8 | 2 + 中 → SP + 强 | 2+MK → 236236+K | 2100 | 2500 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs verified |
| 9 | 9 | 2 + 中 → [4]6 + 中 | 2+MK → [4]6+MP | 1900 | 1900 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 10 | 10 | 2 + 中 → [4]6 + 弱 | 2+MK → [4]6+LP | 1700 | 1700 | drive 0 | 5.3 | low | 0/1 pairs verified |
| 11 | 11 | 2 + 中 → [4] + SP | 2+MK → [4]6+LP | 1460 | 1700 | drive 0 | 6.0 | low | 0/1 pairs verified |
| 12 | 12 | 2 + 中 → 2 + AUTO + SP | 2+MK → 623+PP | 1460 | 1700 | OD 1, drive 0 | 6.5 | high | 0/1 pairs verified |
| 13 | 13 | 2 + 中 → 236 + 强 | 2+MK → 236+HK | 1000 | 1000 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 14 | 14 | 2 + 中 → [4] + AUTO + SP | 2+MK → [4]6+PP | 820 | 900 | OD 1, drive 20000 | 6.5 | low | 0/1 pairs verified |
| 15 | 15 | 2 + 中 → AUTO + SP | 2+MK → 214+PP | 820 | 900 | OD 1, drive 20000 | 6.0 | low | 0/1 pairs verified |
| 16 | 16 | 2 + 中 → 236 + 弱 | 2+MK → 236+LK | 800 | 800 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 17 | 17 | 2 + 中 → 236 + 中 | 2+MK → 236+MK | 800 | 800 | drive 0 | 6.2 | high | 0/1 pairs verified |
| 18 | 18 | 2 + 中 → 214 + 弱 | 2+MK → 214+LP | 800 | 800 | drive 0 | 6.2 | low | 0/1 pairs verified |
| 19 | 19 | 2 + 中 → 214 + 中 | 2+MK → 214+MP | 800 | 800 | drive 0 | 6.2 | low | 0/1 pairs verified |
| 20 | 20 | 2 + 中 → 214 + 强 | 2+MK → 214+HP | 800 | 800 | drive 0 | 6.2 | low | 0/1 pairs verified |
