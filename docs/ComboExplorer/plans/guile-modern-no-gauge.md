...
Generated 2026-09-16T02:29:09Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 2 + 强 → [2]8 + 强 | 2+HK → 2+HP → [2]8+HK | 2310 | 2550 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 2 + 强 → [2]8 + 中 | 2+HK → 2+HP → [2]8+MK | 2230 | 2450 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 4 + 强 → [2]8 + 强 | 2+HK → 4+HP → [2]8+HK | 2210 | 2450 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 2 + 强 → [2]8 + 弱 | 2+HK → 2+HP → [2]8+LK | 2150 | 2350 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 5 | 5 | 3 + 强 → 4 + 强 → [2]8 + 中 | 2+HK → 4+HP → [2]8+MK | 2130 | 2350 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 2 + 强 → [2] + AUTO + SP | 2+HK → 2+HP → [2]8+HK | 2118 | 2550 | drive 0 | 8.5 | medium | 0/2 pairs reproduced |
| 7 | 7 | 强 → [2]8 + 强 | HP → [2]8+HK | 2100 | 2100 | drive 0 | 4.8 | low | 0/1 pairs reproduced |
| 8 | 8 | 2 + 强 → [2]8 + 强 | 2+HP → [2]8+HK | 2100 | 2100 | drive 0 | 5.3 | high | 0/1 pairs reproduced |
| 9 | 9 | 强 → 2 + 弱 → [2]8 + 强 | HK → 2+LP → [2]8+HK | 2060 | 2300 | drive 0 | 6.8 | medium | 0/2 pairs reproduced |
| 10 | 10 | 6 + 强 → 弱 → [2]8 + 强 | 6+HP → LP → [2]8+HK | 2060 | 2300 | drive 0 | 6.8 | medium | 0/2 pairs reproduced |
| 11 | 11 | 6 + 强 → 2 + 弱 → [2]8 + 强 | 6+HP → 2+LP → [2]8+HK | 2060 | 2300 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 2 + 强 → [2] + SP | 2+HK → 2+HP → [2]8+MK | 2054 | 2450 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 2 + 强 → [2]8 + SP | 2+HK → 2+HP → [2]8+MK | 2054 | 2450 | drive 0 | 9.3 | medium | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 4 + 强 → [2]8 + 弱 | 2+HK → 4+HP → [2]8+LK | 2050 | 2250 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 15 | 15 | 3 + 强 → 6 + 强 → [2]8 + 弱 | 2+HK → 6+HP → [2]8+LK | 2050 | 2250 | drive 0 | 7.3 | medium | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 4 + 强 → [2] + AUTO + SP | 2+HK → 4+HP → [2]8+HK | 2018 | 2450 | drive 0 | 8.5 | medium | 0/2 pairs reproduced |
| 17 | 17 | 强 → [2]8 + 中 | HP → [2]8+MK | 2000 | 2000 | drive 0 | 4.8 | low | 0/1 pairs reproduced |
| 18 | 18 | 2 + 强 → [2]8 + 中 | 2+HP → [2]8+MK | 2000 | 2000 | drive 0 | 5.3 | high | 0/1 pairs reproduced |
| 19 | 19 | 4 + 强 → [2]8 + 强 | 4+HP → [2]8+HK | 2000 | 2000 | drive 0 | 5.3 | high | 0/1 pairs reproduced |
| 20 | 20 | 强 → 2 + 弱 → [2]8 + 中 | HK → 2+LP → [2]8+MK | 1980 | 2200 | drive 0 | 6.8 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/guile-modern-plan-no-gauge.json  (22 pairs, 44353 bytes)
