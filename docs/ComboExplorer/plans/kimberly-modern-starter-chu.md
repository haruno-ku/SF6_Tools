...
Generated 2026-09-16T02:19:44Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 中 → 236236 + 强 | MP → 236236+P | 4540 | 4540 | SA 1, drive >=0 (1 unknown) | 8.4 | low | 0/1 pairs reproduced |
| 2 | 2 | 2 + 中 → 弱 → 236236 + 强 | 2+MK → LP → 236236+P | 4010 | 4810 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 3 | 3 | 2 + 中 → 2 + 弱 → 236236 + 强 | 2+MK → 2+LP → 236236+P | 4010 | 4810 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 4 | 4 | 中 → 2 + SP + 强 | MP → 236236+P | 3740 | 4540 | SA 1, drive >=0 (1 unknown) | 6.0 | low | 0/1 pairs reproduced |
| 5 | 5 | 2 + 中 → 弱 → 2 + SP + 强 | 2+MK → LP → 236236+P | 3370 | 4810 | SA 1, drive >=0 (1 unknown) | 8.0 | low | 0/2 pairs reproduced |
| 6 | 6 | 2 + 中 → 2 + 弱 → 2 + SP + 强 | 2+MK → 2+LP → 236236+P | 3370 | 4810 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 7 | 7 | 中 → 214214 + 中 | MP → 214214+P | 3340 | 3340 | SA 1, drive >=0 (1 unknown) | 8.4 | high | 0/1 pairs reproduced |
| 8 | 8 | 2 + 中 → 弱 → 214214 + 中 | 2+MK → LP → 214214+P | 3050 | 3610 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs reproduced |
| 9 | 9 | 2 + 中 → 2 + 弱 → 214214 + 中 | 2+MK → 2+LP → 214214+P | 3050 | 3610 | SA 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 10 | 10 | 中 → 4 + SP + 强 | MP → 214214+P | 2780 | 3340 | SA 1, drive >=0 (1 unknown) | 6.0 | high | 0/1 pairs reproduced |
| 11 | 11 | 2 + 中 → 弱 → 4 + SP + 强 | 2+MK → LP → 214214+P | 2602 | 3610 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs reproduced |
| 12 | 12 | 2 + 中 → 2 + 弱 → 4 + SP + 强 | 2+MK → 2+LP → 214214+P | 2602 | 3610 | SA 1, drive >=0 (1 unknown) | 8.5 | medium | 0/2 pairs reproduced |
| 13 | 13 | 中 → 236236 + 弱 | MP → 236236+K | 2340 | 2340 | SA 1, drive >=0 (1 unknown) | 8.4 | high | 0/1 pairs reproduced |
| 14 | 14 | 2 + 中 → 弱 → 236236 + 弱 | 2+MK → LP → 236236+K | 2250 | 2610 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs reproduced |
| 15 | 15 | 2 + 中 → 2 + 弱 → 236236 + 弱 | 2+MK → 2+LP → 236236+K | 2250 | 2610 | SA 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs reproduced |
| 16 | 16 | 中 → SP + 强 | MP → 236236+K | 1980 | 2340 | SA 1, drive >=0 (1 unknown) | 5.5 | high | 0/1 pairs reproduced |
| 17 | 17 | 2 + 中 → 弱 → SP + 强 | 2+MK → LP → 236236+K | 1962 | 2610 | SA 1, drive >=0 (1 unknown) | 7.5 | medium | 0/2 pairs reproduced |
| 18 | 18 | 2 + 中 → 2 + 弱 → SP + 强 | 2+MK → 2+LP → 236236+K | 1962 | 2610 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs reproduced |
| 19 | 19 | 2 + 中 → 弱 → 3 + 强 | 2+MK → LP → 2+HK | 1458 | 1620 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 20 | 20 | 2 + 中 → 弱 → 236 + 弱 | 2+MK → LP → 236+LP | 1458 | 1620 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/kimberly-modern-plan-starter-chu.json  (22 pairs, 43711 bytes)
