...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 中 → 3 + 强 → 214 + 强 | 2+MK → 2+HK → 214+HP | 3360 | 3800 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 2 | 2 | 3 + 强 → 2 + 中 → 214 + 强 | 2+HK → 2+MK → 214+HP | 3360 | 3800 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 3 | 3 | 3 + 强 → 4 + 强 → 214 + 强 | 2+HK → 4+HK → 214+HP | 3160 | 3600 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 4 | 4 | 2 + 中 → 3 + 强 → 214 + 中 | 2+MK → 2+HK → 214+MP | 3120 | 3500 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 5 | 5 | 3 + 强 → 2 + 中 → 214 + 中 | 2+HK → 2+MK → 214+MP | 3120 | 3500 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 6 | 6 | 3 + 强 → 214 + 强 | 2+HK → 214+HP | 3100 | 3100 | drive 0 | 6.2 | medium | 0/1 pairs verified |
| 7 | 7 | 强 → 214 + 强 | HP → 214+HP | 3000 | 3000 | drive 0 | 5.7 | low | 0/1 pairs verified |
| 8 | 8 | 2 + 中 → 4 + 强 → 214 + 强 | 2+MK → 4+HK → 214+HP | 2960 | 3400 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 9 | 9 | 3 + 强 → 弱 → 214 + 强 | 2+HK → LP → 214+HP | 2960 | 3400 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 10 | 10 | 3 + 强 → 2 + 弱 → 214 + 强 | 2+HK → 2+LP → 214+HP | 2960 | 3400 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 11 | 11 | 2 + 中 → 3 + 强 → 214 + 弱 | 2+MK → 2+HK → 214+LP | 2920 | 3250 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 12 | 12 | 3 + 强 → 2 + 中 → 214 + 弱 | 2+HK → 2+MK → 214+LP | 2920 | 3250 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 13 | 13 | 3 + 强 → 4 + 强 → 214 + 中 | 2+HK → 4+HK → 214+MP | 2920 | 3300 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 14 | 14 | 2 + 中 → 214 + 强 | 2+MK → 214+HP | 2900 | 2900 | drive 0 | 6.2 | medium | 0/1 pairs verified |
| 15 | 15 | 2 + 强 → 弱 → 214 + 强 | 2+HP → LP → 214+HP | 2860 | 3300 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 16 | 16 | 2 + 强 → 2 + 弱 → 214 + 强 | 2+HP → 2+LP → 214+HP | 2860 | 3300 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 17 | 17 | 3 + 强 → 214 + 中 | 2+HK → 214+MP | 2800 | 2800 | drive 0 | 6.2 | medium | 0/1 pairs verified |
| 18 | 18 | 2 + 中 → 弱 → 214 + 强 | 2+MK → LP → 214+HP | 2760 | 3200 | drive 0 | 7.7 | medium | 0/2 pairs verified |
| 19 | 19 | 2 + 中 → 2 + 弱 → 214 + 强 | 2+MK → 2+LP → 214+HP | 2760 | 3200 | drive 0 | 8.2 | medium | 0/2 pairs verified |
| 20 | 20 | 6 + 中 → 弱 → 214 + 强 | 6+MK → LP → 214+HP | 2760 | 3200 | drive 0 | 7.7 | medium | 0/2 pairs verified |
