...
Generated 2026-09-16T02:33:34Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 强 → 236236 + 强 | 2+HK → HP → 236236+P | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 2 | 2 | 强 → 236236 + 强 | HP → 236236+P | 5000 | 5000 | SA 1, drive >=0 (1 unknown) | 8.4 | low | 0/1 pairs reproduced |
| 3 | 3 | 3 + 强 → 2 + 强 → 236236 + 强 | 2+HK → 2+HP → 236236+P | 5000 | 5800 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 4 | 4 | 2 + 强 → 236236 + 强 | 2+HP → 236236+P | 4900 | 4900 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 5 | 5 | 3 + 强 → 236236 + 强 | 2+HK → 236236+P | 4900 | 4900 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 6 | 6 | 3 + 强 → 4 + 强 → 236236 + 强 | 2+HK → 4+HK → 236236+P | 4900 | 5700 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 7 | 7 | 4 + 强 → 236236 + 强 | 4+HK → 236236+P | 4800 | 4800 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 8 | 8 | 3 + 强 → 2 + 中 → 236236 + 强 | 2+HK → 2+MK → 236236+P | 4600 | 5400 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 9 | 9 | 强 → 弱 → 236236 + 强 | HP → LP → 236236+P | 4500 | 5300 | SA 1, drive >=0 (1 unknown) | 9.9 | low | 0/2 pairs reproduced |
| 10 | 10 | 强 → 2 + 弱 → 236236 + 强 | HP → 2+LP → 236236+P | 4500 | 5300 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 11 | 11 | 2 + 中 → 236236 + 强 | 2+MK → 236236+P | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 12 | 12 | 3 + 强 → 强 → 2 + SP + 强 | 2+HK → HP → 236236+P | 4460 | 5900 | SA 1, drive >=0 (1 unknown) | 8.0 | low | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 弱 → 236236 + 强 | 2+HK → LP → 236236+P | 4400 | 5200 | SA 1, drive >=0 (1 unknown) | 10.4 | low | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 2 + 弱 → 236236 + 强 | 2+HK → 2+LP → 236236+P | 4400 | 5200 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 15 | 15 | 3 + 强 → 2 + 强 → 2 + SP + 强 | 2+HK → 2+HP → 236236+P | 4360 | 5800 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 强 → 214214 + 中 | 2+HK → HP → 214214+K | 4300 | 4900 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 强 → 22 + 弱 + 中 + 强 | 2+HK → HP → 214214+P | 4300 | 4900 | SA 1, drive >=0 (1 unknown) | 7.8 | medium | 0/2 pairs reproduced |
| 18 | 18 | 4 + 强 → 2 + 弱 → 236236 + 强 | 4+HK → 2+LP → 236236+P | 4300 | 5100 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 19 | 19 | 3 + 强 → 4 + 强 → 2 + SP + 强 | 2+HK → 4+HK → 236236+P | 4260 | 5700 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 20 | 20 | 强 → 2 + SP + 强 | HP → 236236+P | 4200 | 5000 | SA 1, drive >=0 (1 unknown) | 6.0 | low | 0/1 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/mbison-modern-plan-max-damage.json  (21 pairs, 43070 bytes)
