...
Generated 2026-09-16T02:30:27Z by `lua tools/lua/plan.lua`. Do not edit by hand; rerun it.
...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 2 + 强 → 3 + 强 → 236236 + 强 | 2+HP → 2+HK → 236236+K | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 2 + 强 → 236236 + 强 | 2+HK → 2+HP → 236236+K | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 6 + 强 → 236236 + 强 | 2+HK → 6+HK → 236236+K | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 4 + 强 → 236236 + 强 | 2+HK → 4+HP → 236236+K | 5100 | 5900 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 5 | 5 | 2 + 强 → 6 + 强 → 236236 + 强 | 2+HP → 6+HK → 236236+K | 5000 | 5800 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 6 | 6 | 2 + 强 → 4 + 强 → 236236 + 强 | 2+HP → 4+HP → 236236+K | 5000 | 5800 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 236236 + 强 | 2+HK → 236236+K | 5000 | 5000 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 8 | 8 | 2 + 强 → 236236 + 强 | 2+HP → 236236+K | 4900 | 4900 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 9 | 9 | 3 + 强 → 2 + 中 → 236236 + 强 | 2+HK → 2+MP → 236236+K | 4900 | 5700 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 10 | 10 | 6 + 强 → 236236 + 强 | 6+HK → 236236+K | 4900 | 4900 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 11 | 11 | 4 + 强 → 236236 + 强 | 4+HP → 236236+K | 4900 | 4900 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 12 | 12 | 2 + 强 → 2 + 中 → 236236 + 强 | 2+HP → 2+MP → 236236+K | 4800 | 5600 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 13 | 13 | 2 + 中 → 236236 + 强 | 2+MP → 236236+K | 4700 | 4700 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs reproduced |
| 14 | 14 | 3 + 强 → 2 + 弱 → 236236 + 强 | 2+HK → 2+LP → 236236+K | 4500 | 5300 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 15 | 15 | 2 + 强 → 3 + 强 → 2 + SP + 强 | 2+HP → 2+HK → 236236+K | 4460 | 5900 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 2 + 强 → 2 + SP + 强 | 2+HK → 2+HP → 236236+K | 4460 | 5900 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 6 + 强 → 2 + SP + 强 | 2+HK → 6+HK → 236236+K | 4460 | 5900 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 4 + 强 → 2 + SP + 强 | 2+HK → 4+HP → 236236+K | 4460 | 5900 | SA 1, drive >=0 (1 unknown) | 8.5 | low | 0/2 pairs reproduced |
| 19 | 19 | 2 + 强 → 2 + 弱 → 236236 + 强 | 2+HP → 2+LP → 236236+K | 4400 | 5200 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
| 20 | 20 | 6 + 强 → 2 + 弱 → 236236 + 强 | 6+HK → 2+LP → 236236+K | 4400 | 5200 | SA 1, drive >=0 (1 unknown) | 10.9 | low | 0/2 pairs reproduced |
...
- reframework/data/ComboExplorer_data/worklist/marisa-modern-plan-max-damage.json  (21 pairs, 43315 bytes)
