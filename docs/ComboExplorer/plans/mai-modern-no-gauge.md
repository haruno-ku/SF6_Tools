...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 2 + 中 → 214 + 弱 | 2+HK → 2+MK → 214+LP | 2040 | 2200 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 2 | 2 | 3 + 强 → 中 → 623 + 弱 | 2+HK → MK → 623+LK | 1920 | 2000 | drive 0 | 7.7 | low | 0/2 pairs verified |
| 3 | 3 | 3 + 强 → 2 + 弱 → 强 | 2+HK → 2+LP → HK | 1920 | 2100 | drive 0 | 5.5 | medium | 0/2 pairs verified |
| 4 | 4 | 3 + 强 → 2 + 弱 → 3 + 强 | 2+HK → 2+LP → 2+HK | 1920 | 2100 | drive 0 | 6.0 | medium | 0/2 pairs verified |
| 5 | 5 | 3 + 强 → 2 + 中 → 4 + SP | 2+HK → 2+MK → 214+LP | 1912 | 2200 | drive 0 | 8.0 | low | 0/2 pairs verified |
| 6 | 6 | 3 + 强 → 2 + 中 → 623 + 强 | 2+HK → 2+MK → 623+HK | 1880 | 2000 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 7 | 7 | 3 + 强 → 中 → 6 + SP | 2+HK → MK → 623+LK | 1856 | 2000 | drive 0 | 7.5 | low | 0/2 pairs verified |
| 8 | 8 | 3 + 强 → 弱 → 214 + 弱 | 2+HK → LK → 214+LP | 1840 | 2000 | drive 0 | 7.7 | low | 0/2 pairs verified |
| 9 | 9 | 3 + 强 → 中 → 弱 | 2+HK → MK → LK | 1840 | 1900 | drive 0 | 5.0 | medium | 0/2 pairs verified |
| 10 | 10 | 3 + 强 → 中 → 2 + 弱 | 2+HK → MK → 2+LP | 1840 | 1900 | drive 0 | 5.5 | medium | 0/2 pairs verified |
| 11 | 11 | 3 + 强 → 2 + 弱 → 214 + 弱 | 2+HK → 2+LP → 214+LP | 1840 | 2000 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 12 | 12 | 3 + 强 → 2 + 弱 → 4 + 强 | 2+HK → 2+LP → 4+HK | 1840 | 2000 | drive 0 | 6.0 | medium | 0/2 pairs verified |
| 13 | 13 | 3 + 强 → 强 | 2+HK → HK | 1800 | 1800 | drive 0 | 3.5 | medium | 0/1 pairs verified |
| 14 | 14 | 3 + 强 → 2 + 中 → 623 + 中 | 2+HK → 2+MK → 623+MK | 1800 | 1900 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 15 | 15 | 3 + 强 → 2 + 中 → 236 + 弱 | 2+HK → 2+MK → 236+LP | 1800 | 1900 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 16 | 16 | 3 + 强 → 2 + 中 → 236 + 中 | 2+HK → 2+MK → 236+MP | 1800 | 1900 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 17 | 17 | 3 + 强 → 2 + 中 → 236 + 强 | 2+HK → 2+MK → 236+HP | 1800 | 1900 | drive 0 | 8.2 | low | 0/2 pairs verified |
| 18 | 18 | 3 + 强 → 2 + 弱 → 中 | 2+HK → 2+LP → MK | 1760 | 1900 | drive 0 | 5.5 | medium | 0/2 pairs verified |
| 19 | 19 | 中 → 2 + 弱 → 强 | MK → 2+LP → HK | 1720 | 1900 | drive 0 | 5.0 | medium | 0/2 pairs verified |
| 20 | 20 | 中 → 2 + 弱 → 3 + 强 | MK → 2+LP → 2+HK | 1720 | 1900 | drive 0 | 5.5 | medium | 0/2 pairs verified |
...
- reframework/data/ComboExplorer_data/worklist/mai-modern-plan-no-gauge.json  (22 pairs, 12526 bytes)
