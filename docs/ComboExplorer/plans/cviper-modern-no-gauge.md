...
|---:|---:|---|---|---:|---:|---|---:|---|---|
| 1 | 1 | 3 + 强 → 2 + 强 → 214 + 弱 | 2+HK → 2+HP → 214+LP | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 2 | 2 | 3 + 强 → 2 + 强 → 214 + 中 | 2+HK → 2+HP → 214+MP | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 3 | 3 | 3 + 强 → 2 + 强 → 214 + 强 | 2+HK → 2+HP → 214+HP | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 4 | 4 | 3 + 强 → 2 + 强 → 236 + 弱 | 2+HK → 2+HP → 236+LK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 5 | 5 | 3 + 强 → 2 + 强 → 236 + 中 | 2+HK → 2+HP → 236+MK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 6 | 6 | 3 + 强 → 2 + 强 → 236 + 强 | 2+HK → 2+HP → 236+HK | 2420 | 2600 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 7 | 7 | 3 + 强 → 2 + 强 → 6 + SP | 2+HK → 2+HP → 214+HP | 2276 | 2600 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 8 | 8 | 3 + 强 → 2 + 强 → 4 + SP | 2+HK → 2+HP → 236+MK | 2276 | 2600 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 9 | 9 | 3 + 强 → 2 + 强 → 623 + 弱 | 2+HK → 2+HP → 623+LP | 2260 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 10 | 10 | 3 + 强 → 2 + 强 → 623 + 中 | 2+HK → 2+HP → 623+MP | 2260 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 11 | 11 | 3 + 强 → 2 + 强 → 623 + 强 | 2+HK → 2+HP → 623+HP | 2260 | 2400 | drive 0 | 8.2 | medium | 0/2 pairs reproduced |
| 12 | 12 | 3 + 强 → 2 + 强 → 1 + SP | 2+HK → 2+HP → 623+LP | 2148 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 13 | 13 | 3 + 强 → 2 + 强 → 2 + SP | 2+HK → 2+HP → 623+MP | 2148 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 14 | 14 | 3 + 强 → 2 + 强 → 3 + SP | 2+HK → 2+HP → 623+HP | 2148 | 2400 | drive 0 | 8.0 | medium | 0/2 pairs reproduced |
| 15 | 15 | 3 + 强 → 2 + 强 → SP | 2+HK → 2+HP → 214+K | 2020 | 2200 | drive 0 | 7.5 | medium | 0/2 pairs reproduced |
| 16 | 16 | 3 + 强 → 弱 → 强 | 2+HK → LP → HP | 1920 | 2100 | drive 0 | 5.0 | medium | 0/2 pairs reproduced |
| 17 | 17 | 3 + 强 → 弱 → 3 + 强 | 2+HK → LP → 2+HK | 1920 | 2100 | drive 0 | 5.5 | medium | 0/2 pairs reproduced |
| 18 | 18 | 3 + 强 → 弱 → 214 + 弱 | 2+HK → LP → 214+LP | 1920 | 2100 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 19 | 19 | 3 + 强 → 弱 → 214 + 中 | 2+HK → LP → 214+MP | 1920 | 2100 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
| 20 | 20 | 3 + 强 → 弱 → 214 + 强 | 2+HK → LP → 214+HP | 1920 | 2100 | drive 0 | 7.7 | medium | 0/2 pairs reproduced |
