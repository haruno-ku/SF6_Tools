...
| 2 | 2 | 4 + 中 → 236236 + 强 | 4+MP → 236236+P | 4500 | 4500 | SA 1, drive >=0 (1 unknown) | 8.9 | low | 0/1 pairs verified |
| 3 | 3 | 2 + 中 → 2 + SP + 强 | 2+MK → 236236+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs verified |
| 4 | 4 | 4 + 中 → 2 + SP + 强 | 4+MP → 236236+P | 3700 | 4500 | SA 1, drive >=0 (1 unknown) | 6.5 | low | 0/1 pairs verified |
| 5 | 5 | 中 → 4 + 中 → 214214 + 中 | MP → 4+MP → 214214+P | 3500 | 4100 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 6 | 6 | 2 + 中 → 214214 + 中 | 2+MK → 214214+P | 3500 | 3500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 7 | 7 | 4 + 中 → 214214 + 中 | 4+MP → 214214+P | 3500 | 3500 | SA 1, drive >=0 (1 unknown) | 8.9 | high | 0/1 pairs verified |
| 8 | 8 | 中 → 弱 → 214214 + 中 | MP → LP → 214214+P | 3300 | 3900 | SA 1, drive >=0 (1 unknown) | 9.9 | medium | 0/2 pairs verified |
| 9 | 9 | 中 → 2 + 弱 → 214214 + 中 | MP → 2+LP → 214214+P | 3300 | 3900 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 10 | 10 | 4 + 中 → 弱 → 214214 + 中 | 4+MP → LP → 214214+P | 3200 | 3800 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 11 | 11 | 4 + 中 → 2 + 弱 → 214214 + 中 | 4+MP → 2+LP → 214214+P | 3200 | 3800 | SA 1, drive >=0 (1 unknown) | 10.9 | medium | 0/2 pairs verified |
| 12 | 12 | 中 → 4 + 中 → 4 + SP + 强 | MP → 4+MP → 214214+P | 3020 | 4100 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs verified |
| 13 | 13 | 2 + 中 → 4 + SP + 强 | 2+MK → 214214+P | 2900 | 3500 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs verified |
| 14 | 14 | 4 + 中 → 4 + SP + 强 | 4+MP → 214214+P | 2900 | 3500 | SA 1, drive >=0 (1 unknown) | 6.5 | high | 0/1 pairs verified |
| 15 | 15 | 中 → 弱 → 4 + SP + 强 | MP → LP → 214214+P | 2820 | 3900 | SA 1, drive >=0 (1 unknown) | 7.5 | medium | 0/2 pairs verified |
| 16 | 16 | 中 → 2 + 弱 → 4 + SP + 强 | MP → 2+LP → 214214+P | 2820 | 3900 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs verified |
| 17 | 17 | 4 + 中 → 弱 → 4 + SP + 强 | 4+MP → LP → 214214+P | 2720 | 3800 | SA 1, drive >=0 (1 unknown) | 8.0 | medium | 0/2 pairs verified |
| 18 | 18 | 4 + 中 → 2 + 弱 → 4 + SP + 强 | 4+MP → 2+LP → 214214+P | 2720 | 3800 | SA 1, drive >=0 (1 unknown) | 8.5 | medium | 0/2 pairs verified |
| 19 | 19 | 中 → 4 + 中 → 236236 + 弱 | MP → 4+MP → 236236+K | 2700 | 3100 | SA 1, drive >=0 (1 unknown) | 10.4 | medium | 0/2 pairs verified |
| 20 | 20 | 中 → 弱 → 236236 + 弱 | MP → LP → 236236+K | 2500 | 2900 | SA 1, drive >=0 (1 unknown) | 9.9 | medium | 0/2 pairs verified |
